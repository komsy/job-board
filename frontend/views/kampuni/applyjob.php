...
$seekId = Jobseeker::find()->where(['userId'=>Yii::$app->user->id])->joinWith('user')->all();
?>
<div class="container">
<div class="applyjob">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($model, 'seekId')->hiddenInput(['value' => $seekId[0]->seekId, 'readonly'=>true])->label(false)  ?>
        <?= $form->field($model, 'jobId')->hiddenInput(['value' => $jobId, 'readonly'=>true])->label(false)  ?>
